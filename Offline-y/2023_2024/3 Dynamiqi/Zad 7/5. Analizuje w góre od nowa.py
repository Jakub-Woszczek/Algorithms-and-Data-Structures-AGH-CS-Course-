...
def MazeFucking_Runner(L):
    ...
    for col in range(1,n):
        ...
        for row_up in range(n - 2, -1, -1):
            ...
            if DQ[row_up][col] != None: # Curr różny od None

                # Teraz ustawiam seeda
                if DQ[row_up][col-1] != 0 and DQ[row_up][col-1] != None and DQ[row_up+1][col] == None:
                    seed = DQ[row_up][col-1] + 1

                elif DQ[row_up + 1][col] != None: # Czy dolny istnieje
                    if quo_vadis[row_up + 1][col][1] == 1 or quo_vadis[row_up + 1][col][2] == 1: # Czy można dorzeć do dolnego z lewej albo z dołu
                        ...
                        # Tutja sprawdze czy seed może nie jest większy
                        print(col,row_up,seed)
