...
L_2 = [[0,1],[1,2],[2,5],[1,4],[2,3],[3,4],[3,6],[6,7]]
def mosciki(L,org_vertex):
    ...
    # Trzeba tablica z czasami odwiedzenia, i lov(), been_here i globalną curr time
    ...
    def DFS(vertex):
        ...
        if parent[vertex] != None and arr_czasy_odwiedzenia[parent[vertex]] < lov[vertex] and vertex != org_vertex:
